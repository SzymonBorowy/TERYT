    ...
    public class TerytWS
    {
        ...
        public class Plik
        {
            ...
            public XmlDocument DajXmlDocument()
            {
                ...
                var sr = new StreamReader(@"C:\temp\Teryt\" + PlikKatalog.nazwa_pliku + @"\" + PlikKatalog.nazwa_pliku + ".xml", System.Text.Encoding.UTF8);
                doc.Load(sr);
        ...
        public Plik PlikTERCAdr;
        public Plik PlikSIMC;
        public Plik PlikSIMCAdr;
        public Plik PlikSIMCSta;
        public Plik PlikULIC;
        public Plik PlikULICAdr;
        public Plik PlikNTS;
        public Plik PlikWMRODZ;
        ...
        public PlikTeryt DajStrukturePelengoTERYTa()
        {
            ...
            var rows = PlikTERC.DajXmlDocument().DocumentElement.SelectNodes("catalog/row"); //podzielenie dokumentu XML po znacznikach <row>
